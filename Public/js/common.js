            ...
            $.getJSON(url, {'fid':fav_id}, function(data){
                ...
                if(jstype == 'store'){
                    $('[nc_store="'+fav_id+'"]').each(function(){
                        $(this).before('<span class="goods-favorite" title="该组织/团体已收藏"><i class="have">&nbsp;</i></span>');
                        $(this).remove();
                    });
                }
            }
...
(function($) {
    $.show_nc_login = function(options) {
        ...
        login_dialog_html.append('<link rel="stylesheet" type="text/css" href="'+SHOP_SITE_URL+'/templates/default/css/sregister.css"><form class="bg" method="post" id="ajax_login" action="'+APP_SITE_URL+settings.action+'"></form>').find('form')			
        	...
        	.append('<ul><li>›&nbsp;如果您没有登录帐号，请先<a class="register" href="'+SHOP_SITE_URL+'/index.php?act=login&amp;op=register">注册志愿者</a>然后登录</li><li>›&nbsp;如果您<a class="forget" href="'+SHOP_SITE_URL+'/index.php?act=login&amp;op=forget_password">忘记密码</a>？，申请找回密码</li></ul>')

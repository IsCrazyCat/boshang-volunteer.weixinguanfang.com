...
protected $Activitycates = array();
    ...
    public function create($id) {
		...
		$lifeservice_shop = D('Shop')->find($ids['shop_id']);//组织/团体信息
        ...
        if (D('Housework')->add($data)) {
			...
			D('Email')->sendMail('email_sj_lifeservice_yuyue', $lifeservice_user['email'], '尊敬的组织/团体，有客户预约'.$this->lifeservicecates[$cate_id['cate_id']]['cate_name'], array(
				'name'=>$data['name'],
				'date'=>$data['date'],
				'time'=>$data['time'],
				'addr'=>$data['addr'],

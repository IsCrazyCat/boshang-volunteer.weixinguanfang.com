...
class AllAction extends CommonAction {
    public function index(){
		...
		$list_shop =$Shop->Field('"组织/团体" as t_name,"shop/detail" as t_url,"shop_id" as t_param,shop_id as t_id,shop_name as t_title,photo as t_photo,tel as t_note')->order($orderby)->where($where_shop)->select();

...
class BookingAction extends CommonAction {
    ...
    private function createCheck() {
        ...
        if (empty($data['details'])) {
            $this->baoError('组织/团体详情不能为空');
        }
        if ($words = D('Sensitive')->checkWords($data['details'])) {
            $this->baoError('组织/团体详情含有敏感词：' . $words);
        } 
